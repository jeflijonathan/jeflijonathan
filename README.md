...
Saya seorang **Fullstack Web Developer** asal Indonesia yang berfokus pada pembangunan aplikasi web yang responsif, berkinerja tinggi, dan berdampak nyata. Saya menggabungkan logika _backend_ yang kuat menggunakan **Laravel & Node.js** dengan antarmuka _frontend_ yang interaktif menggunakan **React & TailwindCSS**.

Bagi saya, _coding_ bukan hanya tentang menulis baris perintah, melainkan tentang memecahkan masalah dan menciptakan pengalaman digital yang mulus bagi pengguna. ✨
...
> _"I don't just write code — I solve problems and build seamless experiences."_
